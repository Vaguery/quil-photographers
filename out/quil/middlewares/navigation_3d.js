...
var vec__8410 = axis;
var a_x = cljs.core.nth.call(null,vec__8410,(0),null);
var a_y = cljs.core.nth.call(null,vec__8410,(1),null);
var a_z = cljs.core.nth.call(null,vec__8410,(2),null);
var vec__8413 = v;
var x = cljs.core.nth.call(null,vec__8413,(0),null);
var y = cljs.core.nth.call(null,vec__8413,(1),null);
var z = cljs.core.nth.call(null,vec__8413,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8416,p__8417){
var vec__8424 = p__8416;
var u1 = cljs.core.nth.call(null,vec__8424,(0),null);
var u2 = cljs.core.nth.call(null,vec__8424,(1),null);
var u3 = cljs.core.nth.call(null,vec__8424,(2),null);
var vec__8427 = p__8417;
var v1 = cljs.core.nth.call(null,vec__8427,(0),null);
var v2 = cljs.core.nth.call(null,vec__8427,(1),null);
var v3 = cljs.core.nth.call(null,vec__8427,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8430_SHARP_){
return (p1__8430_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8431_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8432_SHARP_,angle_lr),angle_ud);
...
var map__8439 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8439__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8439__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__8441 = cljs.core._EQ_;
var expr__8442 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8441.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8442))){
return straight;
} else {
if(cljs.core.truth_(pred__8441.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8442))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8441.call(null,quil.middlewares.navigation_3d.space,expr__8442))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8441.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8442))){
return up;
} else {
if(cljs.core.truth_(pred__8441.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8442))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8441.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8442))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__8439,map__8439__$1,up,straight){
return (function (p1__8433_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8433_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__8439,map__8439__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8444_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8456_8467 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8456_8468__$1 = ((((!((map__8456_8467 == null)))?((((map__8456_8467.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8456_8467.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8456_8467):map__8456_8467);
var vec__8457_8469 = cljs.core.get.call(null,map__8456_8468__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8470 = cljs.core.nth.call(null,vec__8457_8469,(0),null);
var c_y_8471 = cljs.core.nth.call(null,vec__8457_8469,(1),null);
var c_z_8472 = cljs.core.nth.call(null,vec__8457_8469,(2),null);
var vec__8460_8473 = cljs.core.get.call(null,map__8456_8468__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8474 = cljs.core.nth.call(null,vec__8460_8473,(0),null);
var u_y_8475 = cljs.core.nth.call(null,vec__8460_8473,(1),null);
var u_z_8476 = cljs.core.nth.call(null,vec__8460_8473,(2),null);
var vec__8463_8477 = cljs.core.get.call(null,map__8456_8468__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8478 = cljs.core.nth.call(null,vec__8463_8477,(0),null);
var p_y_8479 = cljs.core.nth.call(null,vec__8463_8477,(1),null);
var p_z_8480 = cljs.core.nth.call(null,vec__8463_8477,(2),null);
quil.core.camera.call(null,p_x_8478,p_y_8479,p_z_8480,(p_x_8478 + c_x_8470),(p_y_8479 + c_y_8471),(p_z_8480 + c_z_8472),u_x_8474,u_y_8475,u_z_8476);
